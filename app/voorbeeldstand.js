...
(() => {
 ...
 if(example&&(missing||storage.getItem(tourKey)!==tourId)){
  ...
  if(tool==='Werkbank'){storage.setItem('mw-project','all');storage.removeItem('lastOpenFile');storage.setItem('mw-document-'+'all','converter/Buurtwerkplaats — projectplan.md');}
 }
