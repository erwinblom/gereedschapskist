...
Een uit Uren schrijven overgenomen factuur bevat `timeSources`: de originele registraties met minuten, tarief, btw, batch en bronhandtekening. Er is één factuurregel per bronregistratie, met quantity 1 en cents = Math.round(minutes * rateCents / 60). De omschrijving noemt tijd en tarief. De bronnen horen bij het onveranderlijke definitieve factuurrecord. Zie ../../koppelingen/FORMAAT.md.
